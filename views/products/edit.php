...
$this->title = 'Edit Product: ' . Html::encode($model->name);
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <?= Html::a('View Product', ['view', 'id' => $model->id], ['class' => 'btn btn-info btn-sm mt-2 mt-md-0']) ?>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="mt-4 d-flex flex-wrap gap-2">
                    <?= Html::submitButton('Update Product', ['class' => 'btn btn-primary me-2 mb-2']) ?>
