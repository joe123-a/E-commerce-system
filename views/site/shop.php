            ...
            <div class="row g-4">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                      ...
                      <?= \yii\helpers\Html::img('@web/img/product-1.png', ['class' => 'img-fluid', 'alt' => '']) ?>
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        ...
                        <?= \yii\helpers\Html::img('@web/img/product-2.png', ['class' => 'img-fluid', 'alt' => '']) ?>
...
<!-- Shop Page Start -->
                ...
                <div class="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="featured-product mb-4">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <?= \yii\helpers\Html::img('@web/img/product-3.png', ['class' => 'img-fluid', 'alt' => '']) ?>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                              <?= \yii\helpers\Html::img('@web/img/product-4.png', ['class' => 'img-fluid', 'alt' => '']) ?>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                               <?= \yii\helpers\Html::img('@web/img/product-5.png', ['class' => 'img-fluid', 'alt' => '']) ?>
                    ...
                    <a href="#">
                        <div class="position-relative">
                            <?= \yii\helpers\Html::img('@web/img/product-banner-2.jpg', [
    ...
    'alt' => 'Image'
                ...
                <div class="col-lg-9 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <?= \yii\helpers\Html::img('@web/img/product-banner-3.jpg', [
    'class' => 'img-fluid w-100 rounded',
    'alt' => 'Image'
]) ?>
                                    ...
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                               <?= \yii\helpers\Html::img('@web/img/product-3.png', [
    ...
    'alt'   => ''
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <?= \yii\helpers\Html::img('@web/img/product-4.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                           <?= \yii\helpers\Html::img('@web/img/product-5.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                           <?= \yii\helpers\Html::img('@web/img/product-6.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                              <?= \yii\helpers\Html::img('@web/img/product-7.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                               <?= \yii\helpers\Html::img('@web/img/product-8.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                            <?= \yii\helpers\Html::img('@web/img/product-9.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                             <?= \yii\helpers\Html::img('@web/img/product-10.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                         <?= \yii\helpers\Html::img('@web/img/product-11.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                <div class="product-new">New</div>
                                ...
                                <div class="col-lg-6">
                                    <div class="products-mini-item border">
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                    <?= \yii\helpers\Html::img('@web/img/product-12.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                    <div class="products-mini-icon rounded-circle bg-primary">
                                ...
                                <div class="col-lg-6">
                                    <div class="products-mini-item border">
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                <?= \yii\helpers\Html::img('@web/img/product-13.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                    <div class="products-mini-icon rounded-circle bg-primary">
                                ...
                                <div class="col-lg-6">
                                    <div class="products-mini-item border">
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                   <?= \yii\helpers\Html::img('@web/img/product-14.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                    <div class="products-mini-icon rounded-circle bg-primary">
                                ...
                                <div class="col-lg-6">
                                    <div class="products-mini-item border">
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                   <?= \yii\helpers\Html::img('@web/img/product-15.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                    <div class="products-mini-icon rounded-circle bg-primary">
                                ...
                                <div class="col-lg-6">
                                    <div class="products-mini-item border">
                                        <div class="row g-0">
                                            <div class="col-5">
                                                <div class="products-mini-img border-end h-100">
                                                    <?= \yii\helpers\Html::img('@web/img/product-16.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt'   => ''
]) ?>
                                                    <div class="products-mini-icon rounded-circle bg-primary">
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <a href="#">
                        <div class="bg-primary rounded position-relative">
                            <?= \yii\helpers\Html::img('@web/img/product-banner.jpg', [
    'class' => 'img-fluid w-100 rounded',
    'alt' => 'Image'
]) ?>
