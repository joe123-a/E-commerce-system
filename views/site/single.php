                    ...
                    <div class="featured-product mb-4">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <?=Html::img('@web/img/product-3.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                               <?=Html::img('@web/img/product-4.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                              <?=Html::img('@web/img/product-5.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <?=Html::img('@web/img/product-6.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                               <?=Html::img('@web/img/product-7.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                               <?=Html::img('@web/img/product-8.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                        ...
                        <div class="col-xl-6">
                            <div class="single-carousel owl-carousel">
                                <div class="single-item"
                                    data-dot="<?=Html::img('@web/img/product-4.png', ['class' => 'img-fluid', 'alt' => '']) ?>"
>
                                ...
                                <div class="single-item"
                                    data-dot="<?=Html::img('@web/img/product-5.png', ['class' => 'img-fluid', 'alt' => '']) ?>">
                                    <div class="single-inner bg-light rounded">
                                        <?=Html::img('@web/img/product-5.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                                    </div>
                                </div>
                                <div class="single-item"
                                    data-dot="<?=Html::img('@web/img/product-6.png', ['class' => 'img-fluid', 'alt' => '']) ?>">
                                    <div class="single-inner bg-light rounded">
                                          <?=Html::img('@web/img/product-6.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                                    </div>
                                </div>
                                <div class="single-item"
                                    data-dot="<?=Html::img('@web/img/product-7.png', ['class' => 'img-fluid', 'alt' => '']) ?>">
                                    <div class="single-inner bg-light rounded">
                                        <?=Html::img('@web/img/product-7.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                                    </div>
                                </div>
                                <div class="single-item"
                                    data-dot="<?=Html::img('@web/img/product-3.png', ['class' => 'img-fluid', 'alt' => '']) ?>">
                                    <div class="single-inner bg-light rounded">
                                        <?=Html::img('@web/img/product-3.png',['class'=>'img-fluid rounded','alt'=>'Image']) ?>
                                    </div>
                                </div>
                ...
                <div class="related-item rounded">
                    <div class="related-item-inner border rounded">
                        <div class="related-item-inner-item">
                            <?=Html::img('@web/img/product-3.png', [
