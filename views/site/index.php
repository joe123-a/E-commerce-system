                                ...
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                                ...
                                                <?=Html::img('@web/img/product-4.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                           <?=Html::img('@web/img/product-5.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                           <?=Html::img('@web/img/product-6.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-new">New</div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                        <?=Html::img('@web/img/product-7.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-sale">Sale</div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                          <?=Html::img('@web/img/product-8.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 8'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                          <?=Html::img('@web/img/product-9.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-new">New</div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                           <?=Html::img('@web/img/product-10.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-sale">Sale</div>
    ...
    'alt' => 'Product 3'
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <?=Html::img('@web/img/product-11.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <?=Html::img('@web/img/product-12.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                           <?= Html::img('@web/img/product-14.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <?=Html::img('@web/img/product-15.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <?= \yii\helpers\Html::img('@web/img/product-17.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                          <?= Html::img('@web/img/product-16.png', [
    'class' => 'img-fluid w-100 rounded-top',
    'alt' => 'Product 3'
]) ?>
                                            <div class="product-details">
    ...
    'alt' => 'Image'
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <?=Html::img('@web/img/product-9.png', ['class' => 'img-fluid w-100 h-100','alt' => 'Image']) ?>
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
    ...
    'alt' => 'Image'
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <?=Html::img('@web/img/product-13.png', [
    'class' => 'img-fluid w-100 h-100',
    'alt' => 'Image'
]) ?>
                                    <div class="products-mini-icon rounded-circle bg-primary">
    ...
    'alt' => 'Image'
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                  <?=Html::img('@web/img/product-17.png', [
    'class' => 'img-fluid w-100 h-100',
    'alt' => 'Image'
]) ?>
                                    <div class="products-mini-icon rounded-circle bg-primary">
